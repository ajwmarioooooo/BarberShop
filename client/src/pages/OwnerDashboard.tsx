...
export function OwnerDashboard() {
  ...
  // Fetch barbers for calendar management
      ...
      <div className="max-w-7xl mx-auto p-4 space-y-6">
        ...
        <Tabs defaultValue="today" className="w-full">
          <TabsList className="grid w-full grid-cols-5 mb-6">
            ...
            <TabsTrigger value="barber-calendars" className="flex items-center gap-2">
      ...
      <TabsContent value="completed">
        <Card className="border-0 bg-gradient-to-r from-green-50 to-emerald-50 shadow-lg">
          <CardHeader className="bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-t-lg">
            ...
            <CardDescription className="text-green-100">Списък на всички завършени услуги</CardDescription>
          </CardHeader>
          <CardContent>
            {completedLoading ? (
              ...
              <div className="space-y-4">
                {completedBookings.map((booking: any) => (
                  <div key={booking.id} className="border-l-4 border-l-green-500 rounded-lg p-4 bg-gradient-to-r from-green-50/50 to-white shadow-md hover:shadow-lg transition-shadow">
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <div className="flex items-center gap-1 text-sm bg-gradient-to-r from-green-500 to-green-600 px-3 py-1.5 rounded-full text-white shadow-md">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="text-sm">
                          <strong>Майстор:</strong> {booking.barberName}
                        </div>
                        <div className="text-sm">
                          <strong>Цена:</strong> <span className="font-semibold text-green-600">{booking.servicePrice} лв</span>
                        </div>
                      </div>
                    </div>
                    ...
                    {booking.notes && (
                      <div className="mt-3 p-3 bg-gradient-to-r from-yellow-50 to-amber-50 border-l-4 border-l-yellow-400 rounded-r-lg text-sm">
                        <strong>Бележки:</strong> {booking.notes}
                      </div>
                    )}

                    <div className="mt-3 text-xs text-gray-500">
                      Дата: {formatDate(booking.appointmentDate)} • Резервация #{booking.id}
                    </div>
                  </div>
                ))}
              </div>
      ...
      <TabsContent value="customers">
        <Card className="border-0 bg-gradient-to-r from-purple-50 to-indigo-50 shadow-lg">
          <CardHeader className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-t-lg">
            ...
            <CardDescription className="text-purple-100">Преглед на всички регистрирани клиенти и техните точки</CardDescription>
          </CardHeader>
          <CardContent>
            {pointsLoading ? (
              <p className="text-center text-muted-foreground py-8">Зареждане...</p>
            ) : customerPoints && customerPoints.length > 0 ? (
              <div className="space-y-4">
                {customerPoints.map((customer: LoyaltyCustomer) => (
                  <div key={customer.id} className="border-l-4 border-l-purple-500 rounded-lg p-4 bg-gradient-to-r from-purple-50/50 to-white shadow-md hover:shadow-lg transition-shadow">
                    <div className="flex justify-between items-start mb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <span className="font-semibold text-gray-800 text-lg">{customer.name}</span>
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-xs text-gray-500">точки</div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        <div className="bg-purple-50 p-2 rounded-lg">
                          <strong className="text-purple-700">Ниво:</strong> 
                          <span className={`ml-2 px-2 py-1 rounded-full text-xs font-medium ${
                            customer.tier === 'VIP' ? 'bg-gold-100 text-gold-800' :
                      ...
                      <div>
                        <div className="bg-indigo-50 p-2 rounded-lg">
                          <strong className="text-indigo-700">Регистрация:</strong> 
                          <span className="ml-2 text-gray-700">{formatDate(customer.createdAt)}</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <p className="text-center text-muted-foreground py-8">
                Няма регистрирани лоялни клиенти
              </p>
            )}
          </CardContent>
        </Card>
